      ...
      <div className="p-4 relative  md:p-8 lg:p-14 my-5 md:my-8 lg:h-[750px] lg:my-14 rounded-xl bg-[#16181A]">
        <div className="flex justify-center my-10 items-center">
          <div>
            ...
            <div className="my-6 lg:w-[550px]">
              <h1 className="font-inter font-medium md:text-2xl text-xl lg:text-4xl xl:text-6xl text-slate-300">
                IT Solutions Tailored
              </h1>
              <h2 className="font-inter font-medium my-4 md:text-2xl text-xl lg:text-4xl xl:text-6xl text-slate-300">
              ...
              <div className="flex justify-center my-6 gap-3">
                ...
                <a
                  href=""
                  className="lg:px-5 text-[16px] py-2 rounded-full border border-orange-400 transition-all hover:bg-white overflow-hidden duration-300 hover:text-black text-white"
                >
                  Start A Free Trial
                </a>
              </div>
        ...
        <div className="flex justify-center">
          ...
          <div className="absolute lg:-bottom-26 lg:left-10 w-full">
            <div className="flex justify-between items-center ">
              <div>
                <div className="lg:p-6 w-[200px] rounded-2xl lg:rotate-12 bg-orange-600">
                  <div>
                ...
                <div className="justify-end flex">
                  <div className="lg:p-6 w-[170px] lg:-rotate-10 rounded-xl bg-black">
                    <div>
                      <h2 className="lg:text-4xl text-white font-semibold text-center">
                        97%
                      </h2>
                      <p className="text-white my-3  text-center">
                        Positive Review
              ...
              <div>
                <div className="bg-slate-800 relative right-14 rounded-[6px] lg:max-w-64 lg:max-h-62 rotate-12 flex justify-center border border-slate-400 lg:p-7">
                  <div className="">
                    <div className="flex justify-center">
